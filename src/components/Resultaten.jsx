...
const cases = [
  {
    ...
    nota: 'Analyse april 2026 — volgend rapport juli 2026',
  },
  {
    nome: 'RAB Romagna',
    luogo: 'Romagna, IT',
    settore: 'Kortetermijnverhuur',
    ...
    nota: 'Analyse april 2026 — systeem gevalideerd voor lancering',
  },
]
    ...
    <div style={{ marginBottom: '12px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', margin: '8px 0 4px' }}>
        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '11px', color: '#A0782A',
          letterSpacing: '0.1em', textTransform: 'uppercase' }}>Na</span>
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 clamp(24px,4vw,64px)' }}>
        <div style={{ marginBottom: 'clamp(40px,5vw,64px)' }}>
          <div style={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: '10px',
            ...
            marginBottom: '1rem' }}>Echte voorbeelden</div>
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 'clamp(13px,1vw,15px)',
            ...
            Het ergste is niet weten dat je die hebt.
          </p>
        </div>
